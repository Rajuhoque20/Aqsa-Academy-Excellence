                ...
                <h2 className="text-gray-600">Write us a message directly</h2>
                    <form className="w-full flex flex-col gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <input required type="text" name="name" placeholder="Enter the Name" className="px-5 py-3 border-2 border-gray-300 w-full text-gray-500 shadow-xl/30 hover:shadow-xs"/>
                        </div>
                        <div className="flex flex-col gap-2">
                            <label htmlFor="name" className="text-gray-600 text-xl">Email</label>
                            <input required type="text" name="email" placeholder="Enter the Email" className="px-5 py-3 border-2 border-gray-300 w-full text-gray-500 shadow-xl/30 hover:shadow-xs"/>
                        </div>
                        <div className="flex flex-col gap-2">
                            <label htmlFor="name" className="text-gray-600 text-xl">Message</label>
                            <textarea required name="message" placeholder="Enter the Message" className="px-5 py-3 border-2 border-gray-300 w-full text-gray-500 shadow-xl/30 hover:shadow-xs"/>
                        </div>
